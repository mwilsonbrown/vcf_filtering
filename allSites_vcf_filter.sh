...
# AllSites (variant and invariant sites) VCF filtering
# August 26, 2024
# Maya Wilson Brown
#
# Filtering at this stage is primarily at the site level,
# not at the population level so running it should be fine through the end of the script
#
...
WORKDIR=/mnt/scratch/wils1582/allSitesVCF
