#!/bin/bash
#
#SBATCH --job-name=variantVCFFilter
#SBATCH --nodes=10
...
#
# change directory
cd /mnt/scratch/wils1582/CBP_CRCGCONP_filtering/
...
## vars
RAW_VCF=/mnt/research/josephslab/Adrian/CBP_NYC_JLv4/CG_subgenome/July14.final_called.v.vcf.gz
